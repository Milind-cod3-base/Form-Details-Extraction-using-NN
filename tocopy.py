...
class FormReader:
    ...
    def __init__(self, form, file):
        ...
        self.model = formAI.runAI() 

    def readForm(self):
        """Iterate through all templates"""
        for t in os.listdir('/home/peterparker/Desktop/FormAI_final/Form-Details-Extraction-using-NN/Templates'):  
            template = cv2.imread('/home/peterparker/Desktop/FormAI_final/Form-Details-Extraction-using-NN/Templates' + t, 0)
            formCopy = self.form.copy()

            self.get_boxes(template, formCopy)

            """Iterate through all boxes of each template"""
            for box in os.listdir('/home/peterparker/Desktop/FormAI_final/Form-Details-Extraction-using-NN/Boxes'):
                box = cv2.imread('/home/peterparker/Desktop/FormAI_final/Form-Details-Extraction-using-NN/Boxes' + box)
                self.getLetters(box)
...
a = FormReader('/home/peterparker/Desktop/FormAI_final/Form-Details-Extraction-using-NN/Scanned_Forms/IMG20221217125450.jpg',"predictions.txt")
a.readForm()